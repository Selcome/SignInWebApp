...
$().ready(function() {
    ...
    //getUserList
    var myDate=new Date();
    var star=new Date(myDate.getFullYear(),myDate.getMonth(),myDate.getDate());
    console.log('mdate',star)
    $.ajax("/p",{
        type:"POST",
...
function _selectThisDay(d){
    ...
    var date=  boxObj.targetObj.value;
    var da=new Date(date);
    var start=new Date(da.getFullYear(),da.getMonth(),da.getDate());
    console.log(start)
